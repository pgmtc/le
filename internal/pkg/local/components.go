...
func getComponents() []Component {
	return []Component{
		Component{
			name: "db",
			image: "orchard/orchard-local-db",
			containerPort: 3306,
			hostPort: 3306,
		...
		Component{
			name: "config",
			image: "orchard/orchard-config-msvc",
			dockerId: "dcmp_orchard-config-msvc_1",
			testUrl:  ""},
		Component{
			name: "gateway",
			image: "orchard/orchard-gateway-msvc",
		...
		Component{
			name: "ui",
			image: "orchard/orchard-doc-analysis-ui",
